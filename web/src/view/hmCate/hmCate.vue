<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="图片地址" prop="imgPath" width="120" />
        <el-table-column align="left" label="类型" prop="type" width="120" />
        <el-table-column sortable align="left" label="排序" prop="sort" width="120" />
        <el-table-column align="left" label="扩展字段" prop="extend" width="120" />
        <el-table-column align="left" label="操作" min-width="120">
            ...
            <el-button type="primary" link icon="edit" class="table-button" @click="updateHmCategoryFunc(scope.row)">变更</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" :title="type==='create'?'添加':'修改'" destroy-on-close>
      <el-scrollbar height="500px">
          <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
            <el-form-item label="分类层级:"  prop="level" >
              <el-input v-model.number="formData.level" :clearable="true" placeholder="请输入分类层级" />
            </el-form-item>
            <el-form-item label="父级id:"  prop="parentId" >
            ...
            <el-form-item label="图片地址:"  prop="imgPath" >
              <el-input v-model="formData.imgPath" :clearable="true"  placeholder="请输入图片地址" />
            </el-form-item>
            <el-form-item label="类型:"  prop="type" >
