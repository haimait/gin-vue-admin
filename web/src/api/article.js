...
// @Param data body model.Article true "创建article表"
...
// @accept application/json
// @Produce application/json
// @Param data body model.Article true "删除article表"
...
// @accept application/json
// @Produce application/json
// @Param data body request.IdsReq true "批量删除article表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"删除成功"}"
// @Router /article/deleteArticle [delete]
...
// @accept application/json
// @Produce application/json
// @Param data body model.Article true "更新article表"
...
// @accept application/json
// @Produce application/json
// @Param data query model.Article true "用id查询article表"
...
// @accept application/json
// @Produce application/json
// @Param data query request.PageInfo true "分页获取article表列表"
