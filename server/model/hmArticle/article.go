...
type Article struct {
	...
	IsLink        *int                   `json:"isLink" form:"isLink" gorm:"column:is_link;comment:isLink;size:1;"`                                       //isLink
	Link          string                 `json:"link" form:"link" gorm:"column:link;comment:Link;size:255;"`                                              //Link
	Type          string                 `json:"type" form:"type" gorm:"column:type;type:enum('article','page','video');comment:类型：article/page/video;" ` //类型：article/page/video
	...
	Top           *int                   `json:"top" form:"top" gorm:"column:top;comment:置顶 1:是 2:否;size:1;"`                                             //置顶 1:是 2:否
	...
	CategoryID    *int                   `json:"categoryId" form:"categoryId" gorm:"column:category_id;comment:所属分类;size:10;"`                            //所属分类
