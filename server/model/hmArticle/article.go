...
type Article struct {
	...
	Category      hmCateModel.HmCategory
	//Category hmCateModel.HmCategory `json:"category" form:"category" gorm:"foreignKey:Category_id;references:ID;comment:所属分类;size:10;"`
}
