...
type HmCategory struct {
      ...
      ImgPath  string `json:"imgPath" form:"imgPath" gorm:"column:img_path;comment:图片地址;size:191;"`  //图片地址 
      Type  string `json:"type" form:"type" gorm:"column:type;type:enum('article','good');comment:类型：article/good;"binding:"required"`  //类型 
